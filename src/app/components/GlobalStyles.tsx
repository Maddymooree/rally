  ...
  return (
    <style>{`
      ...
      *::-webkit-scrollbar { display: none; }
      ...
      .f1 { top: -6%; left: -4%; width: clamp(165px,22vw,278px); height: clamp(225px,30vw,378px); transform: rotate(-5deg); z-index: 3; background: var(--secondary); }
      ...
      .f3 { top: -5%; right: -3%; width: clamp(185px,20vw,252px); height: clamp(255px,28vw,348px); transform: rotate(5deg); z-index: 3; background: var(--secondary); }
